...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default=r'E:\Project\city-simulator\code\unity\CitySim\Assets\Plugins\yolo-lite\weights\best.pt', help='weights path')  # from yolov5/models/
