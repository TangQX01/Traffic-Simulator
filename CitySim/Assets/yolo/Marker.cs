...
sealed class Marker : MonoBehaviour
{
    ...
    public static string[] _labels = new[]
    {
        "No Right-turn", "No Left-turn", "No U-turn", "No Parking"
    };
    ...
    public void SetAttributes(in Detection d)
    {
        ...
        /// <summary>
        /// Tqx: Expanding the prediction box
        /// </summary>
        w += w/2;
        h += h/2;
        ...
        /// <summary>
        /// Tqx: If the predicted score is less than 90%, it is not show.
        /// </summary>
        if (d.score < 0.9) return;
