...
sealed class MyVisualizer : MonoBehaviour
{
    #region Editable attributes

    [SerializeField] Texture m_SourceTexture = null;
    ...
    void Update()
    {
        _detector.ProcessImage(m_SourceTexture, _threshold);
        var i = 0;
        /// <summary>
        /// Tqx: _detector.Detections中的d为每个Detection
        /// </summary>
        ...
        _preview.texture = m_SourceTexture;
    }
