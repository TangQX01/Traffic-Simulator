...
using SIP.FastVRTools.MultiTouch.OSC.NET;

namespace SIP.FastVRTools.MultiTouch.TUIO
{
    /**
    ...
    public class TuioClient
    {
        ...
        {
            return statusString + " PC:" + packetCount + " PEC:" + packetErrorCount + " BC:" + bundleCount + " MC:" + messageCount + " OC:" + objectCount + " CC:" + cursorCount;
        }
